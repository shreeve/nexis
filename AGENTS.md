...
| `zig build test --summary all` | the gate, 154 steps, about a minute from a warm cache: all of the above, every property test, the layering check and a compile check of `bench/` |
