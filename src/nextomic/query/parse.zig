...
test "vector form: find specs, in bindings, where clause kinds" {
    ...
    const q = b.vec(&.{
        b.kw("find"),                                                  b.sym("?n"),                                                   b.lst(&.{ b.sym("count"), b.sym("?e") }),
        b.kw("in"),                                                    b.sym("$"),                                                    b.sym("?age"),
        b.vec(&.{ b.sym("?tag"), b.sym("...") }),                      b.vec(&.{b.vec(&.{ b.sym("?a"), b.sym("?b") })}),              b.sym("%"),
        b.kw("with"),                                                  b.sym("?w"),
        b.kw("where"),                                                 b.vec(&.{ b.sym("?e"), b.kw("user/name"), b.sym("?n") }),      b.vec(&.{ b.sym("?e"), b.kw("user/age"), b.sym("?age") }),
        b.vec(&.{ b.sym("?e"), b.kw("user/tags"), b.sym("?tag") }),    b.vec(&.{b.lst(&.{ b.sym("<"), b.sym("?age"), b.int(40) })}), b.vec(&.{ b.lst(&.{ b.sym("str"), b.sym("?n"), b.str("!") }), b.sym("?w") }),
