...
zig build test --summary all      # the gate: 1371 tests, 144 steps, ~4 min wall
```

The gate's last line reads `Build Summary: 144/144 steps succeeded;
1371/1371 tests passed`, preceded by `golden: ok=10 updated=0
